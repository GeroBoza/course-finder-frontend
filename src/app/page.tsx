...
export default async function Home() {
    ...
    return (
        <div className="animate-fade-in">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <p className="text-xl md:text-2xl text-green-100 max-w-3xl mx-auto leading-relaxed">
                            "Divulgar es acercarnos al conocimiento y fomentar
                            el aprendizaje"
                        </p>
                    </div>
                </div>
            ...
            {/* Categories Section */}
            <section className="py-20 bg-gradient-to-b from-green-200 to-green-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">
                            Categorías
                    ...
                    <div className="flex flex-wrap justify-center gap-3">
                        {categories.map((category) => (
                            ...
                            >
                                <CategoryBadge
                                    category={category}
                                    className="cursor-pointer hover:bg-gradient-to-r hover:from-green-500 hover:to-green-600 hover:text-white transition-all duration-300 text-lg px-6 py-3 shadow-md hover:shadow-lg"
                                />
                            </Link>
                        ))}
                    </div>
