                    ...
                    <div className="flex flex-wrap justify-center gap-3">
                        {categories.map((category) => (
                            ...
                            >
                                <CategoryBadge
                                    category={category}
                                    className="cursor-pointer hover:bg-gradient-to-r hover:from-primary-500 hover:to-primary-600 hover:text-white transition-all duration-300 text-lg px-6 py-3 shadow-md hover:shadow-lg"
                                />
                            </Link>
                        ))}
                    </div>
